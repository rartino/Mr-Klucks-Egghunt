...
function main() {
    ...
    const refGiveQuest = collectRegexMatches(gameText, /giveQuest:\s*'([^']+)'/g);
    const refPayQuest = collectRegexMatches(gameText, /payQuest:\s*'([^']+)'/g);
    const refQuestActive = collectRegexMatches(gameText, /questActive:\s*'([^']+)'/g);
    const refQuestComplete = collectRegexMatches(gameText, /questComplete:\s*'([^']+)'/g);
    ...
    const refFlag = collectRegexMatches(gameText, /flag:\s*'([^']+)'/g);
    const refNotFlag = collectRegexMatches(gameText, /notFlag:\s*'([^']+)'/g);
    const refFlag2 = collectRegexMatches(gameText, /flag2:\s*'([^']+)'/g);
