        ...
        dialogues: [
            ...
            { cond: { flag: 'met_king', notFlag: 'princess_gave_key' },
              lines: ["Psst! Mr. Kluck! Over here, quickly!",
                       "Father is acting strange. He's not himself.",
                       "Take this key. Find the hermit in the mountain cave behind the castle.",
    ...
    // ==================== MAP 3 NPCs (Dark Reaches) ====================
    {
        ...
        dialogues: [
            ...
            { cond: { flag: 'found_witch_lair' },
              lines: ["Still need that Dispel Potion? Bring me 3 Ice Crystals.",
                       "They grow in the frozen peaks to the north."] },
            { cond: { flag: 'confronted_blueberry' },
